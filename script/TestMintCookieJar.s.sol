...
//         bytes memory _initializer = abi.encode(user1, periodLength, cookieAmount, cookieToken, allowList);

//         CookieNFT(nft).cookieMint(listCookieJarImp, _initializer, details, address(0), 0);
